...
namespace ClassLibrary.Interfaces
{
    public interface ITodoRepository
    {
        ...
        /// with appropriate message if user is not the owner of the To do item
        /// </summary >
        ...
        /// the owner of the To do item
        /// </summary >
        /// <param name ="todoId"> To do Id </param >
        /// <param name ="userId">Id of the user that is trying to remove the data
        /// </param >
